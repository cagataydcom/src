const dataPath = [process.cwd() + "/data/", "../../data/"];
...
module.exports = class Util {
    ...
    hostConfig = (dirname) => { dirname = dirname.split("\\web\\hosts\\"); dirname[1] = dirname[1].split("\\")[0]; delete require.cache[require.resolve(dirname.join("\\web\\hosts\\") + "/config.json")]; return require(dirname.join("\\web\\hosts\\") + "/config.json") };
