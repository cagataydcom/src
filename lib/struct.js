...
module.exports = new class Struct {
    express = (app, options = { passport: false }) => {
        ...
        if (src.options.devMode) { delete session.cookie; if (typeof cors.origin === "object") cors.origin = cors.origin.map(_ => _.replace("https", "http").replace("cagatayd.com", "localhost")) }
